...
public class KmlThruputTestHeapBuffer {
...
//    private List<Path> files;
    ...
    public KmlThruputTestHeapBuffer() {
    }
...
AtomicLong time=new AtomicLong(0);
        ...
        System.out.println("Placebo on (heap)" + SRC);
    ...
    public void testBBSplit() throws IOException {
        ...
        System.out.println("ByteBufferSplittable on (heap)" + SRC);
    ...
    public void testLazySplit() throws IOException {
        ...
        System.out.println("ShallowSplittable on (heap)" + SRC);
        System.out.println(bytes[0] + " bytes in " + (time .get()/ 1000.0) + " seconds, " + bytes[0] / time .get()* 1000.0 / 1024.0 / 1024.0 + "mb/second");
    ...
    public void testGson() throws IOException {
        ...
        System.out.println("Gson's JsonParser on (heap)" + SRC);
        double v = time.get();
